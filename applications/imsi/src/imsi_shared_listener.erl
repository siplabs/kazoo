...
-define(RESPONDERS, [{'imsi_handle_authn', [{<<"gsm">>, <<"authn_req">>}]}
                    ,{'imsi_handle_nonce', [{<<"gsm">>, <<"nonce_req">>}]}
                    ,{'imsi_handle_authz', [{<<"trusted">>, <<"authz_req">>}]}
                    ]).
-define(BINDINGS, [{'trusted', []}
                   ,{'gsm', []}
                   ,{'self', []}
                  ]).
-define(SERVER, ?MODULE).
-define(REG_QUEUE_NAME, <<"imsi_listener">>).
